...
-- Día 2026-01-27
-- Jose:   facturas 1, 2 → labor = 45000 + 60000 = 105000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (1, '2026-01-27', 105000.00, 73500.00, 31500.00, 2);

-- Andrés: facturas 3, 4 → labor = 80000 + 35000 = 115000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (2, '2026-01-27', 115000.00, 80500.00, 34500.00, 2);

-- Carlos: facturas 5, 6 → labor = 40000 + 30000 = 70000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (3, '2026-01-27', 70000.00, 49000.00, 21000.00, 2);

-- Julián: factura 8 (factura 7 anulada) → labor = 25000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (4, '2026-01-27', 25000.00, 17500.00, 7500.00, 1);

-- Día 2026-01-28
-- Jose:   facturas 9, 10, 11, 18 → labor = 65000 + 35000 + 40000 + 20000 = 160000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (1, '2026-01-28', 160000.00, 112000.00, 48000.00, 4);

-- Andrés: facturas 12, 13, 19 → labor = 70000 + 45000 + 30000 = 145000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (2, '2026-01-28', 145000.00, 101500.00, 43500.00, 3);

-- Carlos: facturas 14, 15, 20 → labor = 50000 + 60000 + 25000 = 135000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (3, '2026-01-28', 135000.00, 94500.00, 40500.00, 3);

-- Julián: facturas 16, 17 → labor = 30000 + 55000 = 85000
INSERT INTO daily_liquidation (mechanic_id, date, total_revenue, mechanic_share, shop_share, invoice_count)
VALUES (4, '2026-01-28', 85000.00, 59500.00, 25500.00, 2);
