...
class VehicleUseCasesTest {
    ...
    @Test
    void getByPlateUseCase_normalizesTrimAndUppercase_beforeLookup() {
    ...
    @Test
    void getByPlateUseCase_whenPlateExists_returnsVehicle() {
    ...
    @Test
    void getByPlateUseCase_whenBlank_throwsValidationError() {
        GetVehicleByPlateUseCase useCase = new GetVehicleByPlateUseCase(vehicleRepository);
    ...
    @Test
    void getByPlateUseCase_whenMissing_throwsVehicleNotFoundException() {
    ...
    @Test
    void resolveUseCase_whenPlateMissing_createsVehicle() {
    ...
    @Test
    void resolveUseCase_whenPlateExists_updatesModel() {
